...
class TicketsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Typetickets', 'Stats', 'Departamentos', 'Vendors','Fases' ,'Tecnicos']
        ];
    ...
    public function view($id = null)
    {
        $ticket = $this->Tickets->get($id, [
            'contain' => ['Typetickets', 'Stats', 'Departamentos', 'Vendors','Fases' ,'Tecnicos', 'Actions']
        ]);
    ...
    public function add()
    {
        ...
        $this->set(compact('ticket', 'typetickets', 'stats', 'departamentos', 'vendors','fases' ,'tecnicos'));
    }
