...
class ActionsController extends AppController
{
    ...
    public function view($id = null)
    {
        $action = $this->Actions->get($id, [
            'contain' => ['Tickets', 'Actiontypes', 'Docs']
        ]);
    ...
    public function add()
    {
        ...
        $tickets = $this->Actions->Tickets->find('list', ['limit' => 200]);
        $actiontypes = $this->Actions->Actiontypes->find('list', ['limit' => 200]);
        $this->set(compact('action', 'tickets', 'actiontypes'));
    }
