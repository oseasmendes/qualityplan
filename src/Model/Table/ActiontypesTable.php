 ...
 * @method \App\Model\Entity\Actiontype newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\Actiontype[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Actiontype|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Actiontype patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Actiontype[] patchEntities($entities, array $data, array $options = [])
