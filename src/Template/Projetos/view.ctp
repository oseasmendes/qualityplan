...
<div class="projetos view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Produtofinal') ?></th>
            <td><?= h($projeto->produtofinal) ?></td>
        </tr>
        <tr>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($projeto->tickets as $tickets): ?>
            <tr>
                <td><?= h($tickets->id) ?></td>
